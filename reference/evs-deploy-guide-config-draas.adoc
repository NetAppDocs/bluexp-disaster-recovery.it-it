...
* link:evs-deploy-guide-config-add-arrays.html["Aggiungere siti vCenter al ripristino di emergenza di BlueXP"]
* link:evs-deploy-guide-add-vcenters.html["Aggiungere cluster vCenter al disaster recovery di BlueXP"]
