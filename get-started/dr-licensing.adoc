...
* Acquista un abbonamento pay-as-you-go (PAYGO) a * NetApp Intelligent Services* con Amazon Web Services (AWS) Marketplace o a Microsoft Azure Marketplace.
...
Al termine del periodo di prova gratuito, puoi acquistare una licenza da NetApp o abbonarti a * NetApp Intelligent Services* tramite AWS Marketplace o Microsoft Azure Marketplace.  Questa procedura fornisce una panoramica di alto livello su come abbonarsi direttamente in uno dei Marketplace.
...
+
Oppure, in alto a destra, seleziona *Visualizza metodi di pagamento*.

+
image:dr-licensing-payment-methods.png["Pagina dei metodi di pagamento BlueXP disaster recovery"]

. Seleziona *Iscriviti in AWS Marketplace* o *Iscriviti in Azure Marketplace*.
. Utilizza AWS Marketplace o Microsoft Azure Marketplace per abbonarti a * NetApp Intelligent Services* e * BlueXP disaster recovery*.
