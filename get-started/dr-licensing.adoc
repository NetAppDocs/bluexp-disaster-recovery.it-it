...
[role="lead"]
Grazie al disaster recovery di BlueXP, puoi usare il servizio in una versione di prova gratuita o Bring Your Own License.
...
.Fasi
. Contattare il rappresentante di vendita NetApp per acquistare una licenza.
...
+
image:draas-license-subscribe-NetApp-option2.png["La pagina della licenza di sottoscrizione o acquisto del disaster recovery di BlueXP"]

. Selezionare *Aggiungi licenza ad BlueXP*. Verrai indirizzato al Digital Wallet di BlueXP.
+
image:digital-wallet-data-services-licenses-tab2.png["Scheda licenze servizi dati del Digital Wallet di BlueXP"]
...
. Selezionare *Aggiungi licenza*.
+
image:byol-digital-wallet-license-add2.png["Pagina Aggiungi licenza al Digital Wallet di NetApp BlueXP"]
